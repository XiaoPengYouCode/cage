...
edit_objbo_inp_F1; %骨inp文件 + E_obj文件  %%todo end1.inp file  output:vert.inp
run_abaqus;
...
% %  更正
copyfile(['U1_ele_nod_dir_P' num2str(ti) '.mat'], ['F1_U1_ele_nod_dir_P' num2str(ti) '.mat']);
% %
...
save(['bone_s_F1_',num2str(t) '.mat'],'bone_s');
save(['obj_bo_F1_',num2str(t) '.mat'],'obj_bo');
...
%     
    ...
    copyfile(['U1_ele_nod_dir_Fv' num2str(tn) '.mat'], ['F1_U1_ele_nod_dir_Fv' num2str(tn) '.mat']);
