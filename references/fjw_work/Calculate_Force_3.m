...
% save([num2str(t) '_F3.mat'],'cage_3d');
t=t+1;
% design_cage inp文件
edit_desicage_inp;  
...
edit_objbo_inp_F3; %骨inp文件 + E_obj文件  %%todo end1.inp file  output:vert.inp
run_abaqus;
...
% %  更正
copyfile(['U1_ele_nod_dir_P' num2str(ti) '.mat'], ['F3_U1_ele_nod_dir_P' num2str(ti) '.mat']);
% %
...
save(['bone_s_F3_',num2str(t) '.mat'],'bone_s');
save(['obj_bo_F3_',num2str(t) '.mat'],'obj_bo');
...
%     
    ...
    copyfile(['U1_ele_nod_dir_Fv' num2str(tn) '.mat'], ['F3_U1_ele_nod_dir_Fv' num2str(tn) '.mat']);
